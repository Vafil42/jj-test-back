import { Controller, Post, Body, UseGuards, Request, Delete, Get, Patch, Put, Param } from '@nestjs/common';
...
export class ReviewController {
    ...
    @ApiOperation({summary: 'Получение отзывов на пользователя по id пользователя'})
    @Get(':id')
